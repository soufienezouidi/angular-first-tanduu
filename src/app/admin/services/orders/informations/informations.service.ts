...
export class InformationsService {
  ...
  getAllUrgentInformations(company_id: any): Observable<any> {
    return this.http.post<any>(
      UrlsService.backendUrl + '/api/admin/orders/informations',
      company_id
    );
  }
  ...
  createInformation(data: any): Observable<any> {
    return this.http.post<any>(
      UrlsService.backendUrl + '/api/admin/orders/informations/create',
      data
    );
  }
  ...
  UpdateInformation(data: any): Observable<any> {
    return this.http.post<any>(
      UrlsService.backendUrl + '/api/admin/orders/informations/update',
      data
    );
  }
}
