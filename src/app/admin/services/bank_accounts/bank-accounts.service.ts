...
export class BankAccounts {
  ...
  getAllBankAccount(data): Observable<any> {
    return this.http.post<any>(
      UrlsService.backendUrl + '/api/admin/bank-accounts',
      data
    );
  }
  ...
  addNewBankAccount(data: any): Observable<any> {
    return this.http.post<any>(
      UrlsService.backendUrl + '/api/admin/add-bank-account',
      data
    );
  }
  ...
  updateBankAccount(data: any): Observable<any> {
    return this.http.post<any>(
      UrlsService.backendUrl + '/api/admin/update/bank-account',
      data
    );
  }
}
