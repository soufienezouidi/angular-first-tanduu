...
export class AddSupplierComponent implements OnInit {
  ...
  createbranch() {
    alert(this.branch + '/ ' + this.generatedmail + '/ ' + this.pass1);
  }
  onChange(deviceValue) {
    this.branch = 'Tanduu ' + deviceValue;
    this.pass1 = deviceValue + 'tnd2022';
    this.generatedmail = deviceValue + 'tnd@tanduu.com';

    this.pass2 = deviceValue + 'tnd2022';
  }
  selectedspec = 'speciality1';
