...
export class CommonServiceService {
  ...
  messages: '';
  SERVER_URL: string = 'https://api.aroundorder.com:1337/api/';
  ...
  lgin(a: string, b: string) {
    ...
    return this.http
      .post(
        'https://api.aroundorder.com:1337/api/users/login',
        JSON.stringify(obj),
        this.httpOptions
      )
      .pipe(retry(1));
  ...
  deletePharmacyTransactions(id) {
    return this.http.delete(
      `${this.SERVER_URL + 'pharmacy_transactions'}/${id}`
    );
  }
